import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, computed, unref, Suspense, nextTick, mergeProps, ref, Fragment, withAsyncContext, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/user/Downloads/lps-v3/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/user/Downloads/lps-v3/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/user/Downloads/lps-v3/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Users/user/Downloads/lps-v3/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia, defineStore } from "pinia";
import { defu } from "C:/Users/user/Downloads/lps-v3/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "C:/Users/user/Downloads/lps-v3/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/auth-DIhDKz73.js")
  },
  {
    name: "chat",
    path: "/chat",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/chat-Ba2E9S2S.js")
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "admin" },
    component: () => import("./_nuxt/admin-CmoQ3T4-.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DP5tEmd0.js")
  },
  {
    name: "catalog",
    path: "/catalog",
    component: () => import("./_nuxt/catalog-CbxyHv6S.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/profile-Bk9PSDq1.js")
  },
  {
    name: "pets-id",
    path: "/pets/:id()",
    component: () => import("./_nuxt/_id_-D7EVDAT3.js")
  },
  {
    name: "users-id",
    path: "/users/:id()",
    component: () => import("./_nuxt/_id_-C--RblmN.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-Ol-QiaCq.js"),
  auth: () => import("./_nuxt/auth-Yd5DGxWg.js")
};
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BYZfbeLj.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CkDgQll4.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DbTH4taZ.js"));
