declare global {
  ...
  const createToken: typeof import('../../server/utils/auth').createToken
  ...
  const getTokenPayload: typeof import('../../server/utils/auth').getTokenPayload
  ...
  const requireRole: typeof import('../../server/utils/auth').requireRole
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/user/Downloads/lps-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/user/Downloads/lps-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hashPassword, verifyPassword, createToken, getTokenPayload, requireAuth, requireRole } from 'C:/Users/user/Downloads/lps-app/server/utils/auth';